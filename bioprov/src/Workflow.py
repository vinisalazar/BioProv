...
class Workflow:
    ...
    def __init__(
        ...
        **kwargs
        ...
        :param file_columns: Name of columns containing files if input_type is 'dataframe'. Name of file tag if input_type is 'directory'.
    ...
    def generate_sampleset(self):
        ...
        _generate_sampleset[self.input_type]
    ...
    def _load_dataframe_input(self):
        ...
        # Build sample set from dataframe
        self._sampleset_from_dataframe(df)
    ...
    def _load_directory_input(self):
        ...
        for ext in file_extensions:
            files.append(glob(path.join(directory, "*." + ext)))
