...
BioProv is a Python library for [W3C-PROV](https://www.w3.org/TR/prov-overview/) representation of biological data. You can use to build workflow and describe relationships between samples, files, users and processes. 
